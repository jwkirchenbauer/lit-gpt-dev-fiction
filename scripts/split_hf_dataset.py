...
def prepare(
    ...
    for subset in subset_names:
        dataset = load_dataset(
            "HuggingFaceTB/cosmopedia", subset, split="train", num_proc=num_proc_load_dataset, cache_dir=cache_dir
        )
    ...
    split_dataset.save_to_disk(
        "/fs/cml-projects/llm-pretraining/llm-retrieval/data/new_splitted_cosmopedia", num_proc=num_proc
    )
