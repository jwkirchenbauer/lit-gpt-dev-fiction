...
def copy_weights_gemma_2(
    ...
    weight_map = {
        ...
        "model.layers.{}.mlp.down_proj.weight": "transformer.h.{l}.mlp.proj.weight",
        "model.layers.{}.input_layernorm.weight": "transformer.h.{l}.norm_1.weight",
        "model.layers.{}.post_attention_layernorm.weight": "transformer.h.{l}.post_attention_norm.weight",
        "model.layers.{}.pre_feedforward_layernorm.weight": "transformer.h.{l}.norm_2.weight",
        "model.layers.{}.post_feedforward_layernorm.weight": "transformer.h.{l}.post_mlp_norm.weight",
        "model.norm.weight": "transformer.ln_f.weight",
        "lm_head.weight": "lm_head.weight",
    }
...
def convert_hf_checkpoint(
    *,
    ...
    elif model_name.lower().startswith("gemma-2-"):  # limit the new logic to just gemma-2-* series
        qkv_weights = {}
